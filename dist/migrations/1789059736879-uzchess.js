...
Object.defineProperty(exports, "Uzchess1789059736879", {
    enumerable: true,
    get: function() {
        return Uzchess1789059736879;
    }
});
let Uzchess1789059736879 = class Uzchess1789059736879 {
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "FK_a2cecd1a3531c0b041e29ba46e1"`);
        await queryRunner.query(`ALTER TABLE "book-categories" RENAME COLUMN "createdat" TO "createD"`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "profileImage" character varying(128)`);
        await queryRunner.query(`ALTER TABLE "users" ADD "login" character varying(64) NOT NULL`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "book-categories" RENAME COLUMN "createD" TO "createdat"`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_a2cecd1a3531c0b041e29ba46e1" FOREIGN KEY ("role_id") REFERENCES "roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    constructor(){
        this.name = 'Uzchess1789059736879';
    }
};

//# sourceMappingURL=1789059736879-uzchess.js.map