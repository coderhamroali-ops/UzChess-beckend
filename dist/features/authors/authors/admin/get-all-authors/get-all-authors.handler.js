...
Object.defineProperty(exports, "GetAllAuthorsHandler", {
    enumerable: true,
    get: function() {
        return GetAllAuthorsHandler;
    }
});
...
let GetAllAuthorsHandler = class GetAllAuthorsHandler {
    async execute(query) {
...
], GetAllAuthorsHandler.prototype, "execute", null);
GetAllAuthorsHandler = _ts_decorate([
