...
Object.defineProperty(exports, "GetAllSouvenirLikesHandler", {
    enumerable: true,
    get: function() {
        return GetAllSouvenirLikesHandler;
    }
});
...
let GetAllSouvenirLikesHandler = class GetAllSouvenirLikesHandler {
    async execute(query) {
...
], GetAllSouvenirLikesHandler.prototype, "execute", null);
GetAllSouvenirLikesHandler = _ts_decorate([
