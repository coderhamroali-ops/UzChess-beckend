...
Object.defineProperty(exports, "GetAllSouvenirColorsHandler", {
    enumerable: true,
    get: function() {
        return GetAllSouvenirColorsHandler;
    }
});
...
let GetAllSouvenirColorsHandler = class GetAllSouvenirColorsHandler {
    async execute(query) {
...
], GetAllSouvenirColorsHandler.prototype, "execute", null);
GetAllSouvenirColorsHandler = _ts_decorate([
