...
Object.defineProperty(exports, "GetAllBooksHandlerP", {
    enumerable: true,
    get: function() {
        return GetAllBooksHandlerP;
    }
});
...
let GetAllBooksHandlerP = class GetAllBooksHandlerP {
    async execute(query) {
...
], GetAllBooksHandlerP.prototype, "execute", null);
GetAllBooksHandlerP = _ts_decorate([
