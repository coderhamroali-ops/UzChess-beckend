...
Object.defineProperty(exports, "GetAllReportCategoriesHandler", {
    enumerable: true,
    get: function() {
        return GetAllReportCategoriesHandler;
    }
});
...
let GetAllReportCategoriesHandler = class GetAllReportCategoriesHandler {
    async execute(query) {
...
], GetAllReportCategoriesHandler.prototype, "execute", null);
GetAllReportCategoriesHandler = _ts_decorate([
