...
Object.defineProperty(exports, "GetAllReportsHandler", {
    enumerable: true,
    get: function() {
        return GetAllReportsHandler;
    }
});
...
let GetAllReportsHandler = class GetAllReportsHandler {
    async execute(query) {
...
], GetAllReportsHandler.prototype, "execute", null);
GetAllReportsHandler = _ts_decorate([
