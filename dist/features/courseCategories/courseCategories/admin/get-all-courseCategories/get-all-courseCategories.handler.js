...
Object.defineProperty(exports, "GetAllCourseCategoriesHandler", {
    enumerable: true,
    get: function() {
        return GetAllCourseCategoriesHandler;
    }
});
...
let GetAllCourseCategoriesHandler = class GetAllCourseCategoriesHandler {
    async execute(query) {
...
], GetAllCourseCategoriesHandler.prototype, "execute", null);
GetAllCourseCategoriesHandler = _ts_decorate([
