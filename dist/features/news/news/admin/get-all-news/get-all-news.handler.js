...
Object.defineProperty(exports, "GetAllNewsHandler", {
    enumerable: true,
    get: function() {
        return GetAllNewsHandler;
    }
});
...
let GetAllNewsHandler = class GetAllNewsHandler {
    async execute(query) {
...
], GetAllNewsHandler.prototype, "execute", null);
GetAllNewsHandler = _ts_decorate([
