...
Object.defineProperty(exports, "GetAllMatchesHandler", {
    enumerable: true,
    get: function() {
        return GetAllMatchesHandler;
    }
});
...
let GetAllMatchesHandler = class GetAllMatchesHandler {
    async execute(query) {
...
], GetAllMatchesHandler.prototype, "execute", null);
GetAllMatchesHandler = _ts_decorate([
