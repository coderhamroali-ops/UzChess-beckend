...
Object.defineProperty(exports, "GetAllDifficultiesHandler", {
    enumerable: true,
    get: function() {
        return GetAllDifficultiesHandler;
    }
});
...
let GetAllDifficultiesHandler = class GetAllDifficultiesHandler {
    async execute(query) {
...
], GetAllDifficultiesHandler.prototype, "execute", null);
GetAllDifficultiesHandler = _ts_decorate([
