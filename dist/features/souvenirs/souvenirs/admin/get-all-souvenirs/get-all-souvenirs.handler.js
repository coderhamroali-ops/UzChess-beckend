...
Object.defineProperty(exports, "GetAllSouvenirsHandler", {
    enumerable: true,
    get: function() {
        return GetAllSouvenirsHandler;
    }
});
...
let GetAllSouvenirsHandler = class GetAllSouvenirsHandler {
    async execute(query) {
...
], GetAllSouvenirsHandler.prototype, "execute", null);
GetAllSouvenirsHandler = _ts_decorate([
