...
Object.defineProperty(exports, "GetAllBookLikesHandler", {
    enumerable: true,
    get: function() {
        return GetAllBookLikesHandler;
    }
});
...
let GetAllBookLikesHandler = class GetAllBookLikesHandler {
    async execute(query) {
...
], GetAllBookLikesHandler.prototype, "execute", null);
GetAllBookLikesHandler = _ts_decorate([
