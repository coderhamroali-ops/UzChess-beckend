...
Object.defineProperty(exports, "CreateBookLikesHandler", {
    enumerable: true,
    get: function() {
        return CreateBookLikesHandler;
    }
});
...
let CreateBookLikesHandler = class CreateBookLikesHandler {
    async execute(payload) {
        ...
        const newLike = _bookLikesentities.BookLikesEntity.create({
            userId: payload.userId,
            bookId: payload.bookId
        });
        return await _bookLikesentities.BookLikesEntity.save(newLike);
    }
};
