...
Object.defineProperty(exports, "GetAllColorsHandlerP", {
    enumerable: true,
    get: function() {
        return GetAllColorsHandlerP;
    }
});
...
let GetAllColorsHandlerP = class GetAllColorsHandlerP {
    async execute(query) {
...
], GetAllColorsHandlerP.prototype, "execute", null);
GetAllColorsHandlerP = _ts_decorate([
